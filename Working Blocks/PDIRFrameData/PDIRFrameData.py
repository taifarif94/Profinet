...
def Print_C_String():
    ...
    # PDIRFrameData with
    # BlockVersionLow = 0
    # BlockHeader, Padding, Padding, (FrameSendOffset, DataLength, ReductionRatio, Phase,
    # FrameID, EtherType, RxPort, FrameDetails, TxPortGroup, [Padding*] a )*
    ...
    # BlockType: 0x0207
    profinet_data.extend(['0x02', '0x07'])
    # BlockLength
    ...
    # FrameSendOffset
    # 0x00001389
    profinet_data.extend(['0x00', '0x00', '0x13', '0x89'])
    ...
    # 0x00
    # 0000 0000 0010 1000
    profinet_data.extend(['0x00', '0x28'])
    ...
    # EtherType
    profinet_data.extend(['0x81', '0x7d'])
    ...
    # TxPortGroup
    # NumberOfTxPortGroups, TxPortGroupArray
    # 0x01
    profinet_data.append('0x01')
    profinet_data.append('0x01')
