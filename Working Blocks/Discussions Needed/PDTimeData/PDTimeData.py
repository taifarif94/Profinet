...
def Print_C_String():
    ...
    # PDTimeData
    # BlockHeader, TimeMasterPriority1, TimeMasterPriority2, TimePLLWindow, [Padding*] a
    ...
    # BlockType: 0x022D
    profinet_data.extend(['0x02', '0x2d'])
    # BlockLength
    ...
    # TimeMasterPriority1
    # Default for role Time Master
    profinet_data.append('0x80')

    # TimeMasterPriority
    # Default
    profinet_data.append('0xF8')

    # TimePLLWindow
    # Default Global Time Opt 1 microsecond / SyncID Mandatory 1 microsecond
    # 0x000003E8
    profinet_data.extend(['0x00', '0x00', '0x03', '0xE8'])
