...
def Print_C_String():
    ...
    # CheckLineDelay
    # BlockHeader, Padding, Padding, LineDelay
    ...
    # BlockType: 0x020B
    profinet_data.extend(['0x02', '0x0b'])
    # BlockLength
