...
def Print_C_String():
    ...
    # BlockType: 0x010C
    profinet_data.extend(['0x01', '0x0C'])
    # BlockLength
    ...
    # # Manually adding padding which will be automated in a later version
    # profinet_data.extend(['0x00', '0x00'])

    # RS_Properties
    # 32 bits all set to 0. Bit 0 is 0 by default all other bits are reserved so set to 0.
    # 0x00000000
    profinet_data.extend(['0x00', '0x00', '0x00', '0x00'])
    # Block Length End
