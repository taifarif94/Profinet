...
def Print_C_String():
    ...
    # ControllerApplicationCycleFactor, TimeDataCycle, TimeIOInput, TimeIOOutput,
    # TimeIOInputValid, TimeIOOutputValid
    ...
    # BlockType: 0x0204
    profinet_data.extend(['0x02', '0x04'])
    # BlockLength
