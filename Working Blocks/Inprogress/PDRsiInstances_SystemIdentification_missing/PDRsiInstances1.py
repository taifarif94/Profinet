...
def Print_C_String():
    ...
    # DeviceType
    profinet_data.extend(['0x44','0x45', '0x56','0x49', '0x43','0x45', '0x31'])
    profinet_data.extend(['0x44','0x45', '0x56','0x49', '0x43','0x45', '0x31'])
    profinet_data.extend(['0x44','0x45', '0x56','0x49', '0x43','0x45', '0x31'])
    profinet_data.extend(['0x44','0x45', '0x56','0x49'])

    # Blank
    profinet_data.append('0x27')

    # OrderID
    # 4F 52 44 45 52 31
    profinet_data.extend(['0x4F', '0x52', '0x44', '0x45', '0x52', '0x31'])
    profinet_data.extend(['0x4F', '0x52', '0x44', '0x45', '0x52', '0x31'])
    profinet_data.extend(['0x4F', '0x52', '0x44', '0x45', '0x52', '0x31'])
    profinet_data.extend(['0x4F', '0x52'])

    # Blank
    profinet_data.append('0x27')

    # Serial Number
    profinet_data.extend(['0x53', '0x45', '0x52', '0x49', '0x41', '0x4C', '0x31'])
    profinet_data.extend(['0x53', '0x45', '0x52', '0x49', '0x41', '0x4C', '0x31'])
    profinet_data.extend(['0x53', '0x45'])

    # Blank
    profinet_data.append('0x27')

    # HWRevision
    profinet_data.extend(['0x30', '0x30', '0x30', '0x30', '0x30'])

    # Blank
    profinet_data.append('0x27')

    # SWRevisionPrefix
    profinet_data.append('0x52')

    # SWRevision
    profinet_data.extend(['0x30', '0x30', '0x30', '0x30', '0x30','0x30', '0x30', '0x30', '0x30'])
