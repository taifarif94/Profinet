...
def Print_C_String():
    ...
    # Since that is 2 octets long, 0x02 is being assigned, referring the number of bits which is 16.
    profinet_data.extend(['0x00', '0x02'])
