...
def Print_C_String():
    ...
    # PDPortFODataReal
    # BlockHeader, Padding, Padding, FiberOpticType, FiberOpticCableType,
    # [FiberOpticManufacturerSpecific*] a , [FiberOpticDiagnosisInfo]
    ...
    # BlockType: 0x0220
    profinet_data.extend(['0x02', '0x20'])
    # BlockLength
    ...
    # FiberOpticCableType
    # Unsigned32.
    # Inside/outside a cable, fixed installation
    # 0x00000001
    profinet_data.extend(['0x00', '0x00', '0x00', '0x01'])
