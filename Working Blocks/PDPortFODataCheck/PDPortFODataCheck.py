...
def Print_C_String():
    ...
    # PDPortFODataCheck
    # BlockHeader, Padding, Padding, MaintenanceRequiredPowerBudget,
    # MaintenanceDemandedPowerBudget, ErrorPowerBudget
    ...
    # BlockType: 0x0223
    profinet_data.extend(['0x02', '0x23'])
    # BlockLength
