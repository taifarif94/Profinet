...
def Print_C_String():
    ...
    # BlockType: 0x0107
    profinet_data.extend(['0x01', '0x07'])
    # BlockLength
    ...
    print("The length excluding type and itself in decimal is: ")
    print(endBlock - startBlock)

    # Assigning Length
    print("The length excluding type and itself in hex is: ")
    ...
    with open('Data/ARRPCBlockReq_alarm_1325.txt', 'w') as f:
