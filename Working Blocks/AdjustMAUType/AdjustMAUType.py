...
def Print_C_String():
    ...
    # AdjustMAUType
    # BlockHeader, Padding, Padding, MAUType, AdjustProperties
    ...
    # BlockType: 0x020E
    profinet_data.extend(['0x02', '0x0e'])
    # BlockLength
