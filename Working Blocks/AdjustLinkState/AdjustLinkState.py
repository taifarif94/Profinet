...
def Print_C_String():
    ...
    # AdjustLinkState
    # BlockHeader, Padding, Padding, LinkState, AdjustProperties
    ...
    # BlockType: 0x021B
    profinet_data.extend(['0x02', '0x1b'])
    # BlockLength
    ...
    # padding: No instructions on how many octets
    profinet_data.extend(['0x00', '0x00'])

    # # Another padding: No instructions on how many octets
    # profinet_data.extend(['0x00', '0x00'])

    # LinkState:
    # Bit 0 – 7:  LinkState.Link 0x01: Up (ready to pass packets)
    # Bit 8 – 15: LinkState.Port: 0x00 Unknown
