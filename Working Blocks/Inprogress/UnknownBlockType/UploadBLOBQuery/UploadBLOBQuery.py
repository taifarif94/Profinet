...
def Print_C_String():
    ...
    # UploadBLOBQuery
    # BlockHeader, Padding, Padding, FromOffsetData
    ...
    # BlockType: 0x0A00??
    profinet_data.extend(['0x0A', '0x00'])
    # BlockLength
