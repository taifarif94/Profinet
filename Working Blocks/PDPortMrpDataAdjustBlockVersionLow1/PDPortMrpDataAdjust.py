...
def Print_C_String():
    ...
    # BlockType: 0x0214
    profinet_data.extend(['0x02', '0x14'])
    # BlockLength
    ...
    # Default UUID for media
    # redundancy domain
    profinet_data.extend(['0xff', '0xff', '0xff', '0xff', '0xff', '0xff', '0xff', '0xff', '0xff', '0xff', '0xff', '0xff', '0xff', '0xff', '0xff', '0xff'])
