...
def Print_C_String():
    ...
    # endBlock = len(profinet_data)

    # remainder = (endBlock - BlockLengthStart) % 4
    # print(endBlock - BlockLengthStart)
    # if remainder !=0:
    #     padding = 4-remainder
