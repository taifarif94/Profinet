...
def Print_C_String():
    ...
    # PDNCDataCheck
    # BlockHeader, Padding, Padding, MaintenanceRequiredDropBudget,
    # MaintenanceDemandedDropBudget, ErrorDropBudget
    ...
    # BlockType: 0x0230
    profinet_data.extend(['0x02', '0x30'])
    # BlockLength
    ...
    # The following have been defined through heuristic approach, no definition given in the profinet.
