...
def Print_C_String():
    ...
    # BlockType: 0x0810
    profinet_data.extend(['0x08', '0x10'])
    # BlockLength
    ...
    # NumberOfAPIs, (API, NumberOfModules, (SlotNumber, ModuleIdentNumber,
    # NumberOfSubmodules, (SubslotNumber, SubmoduleIdentNumber)*)*)*
