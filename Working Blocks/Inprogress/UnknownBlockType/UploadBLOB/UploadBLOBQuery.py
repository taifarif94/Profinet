...
def Print_C_String():
    ...
    # UploadBLOB
    # BlockHeader, Padding, Padding, FromOffsetData, NextOffsetData, TotalSize, Data*
    ...
    # BlockType: 0x0A01??
    profinet_data.extend(['0x0A', '0x01'])
    # BlockLength
