...
def Print_C_String():
    ...
    # IODReadReqHeader: BlockHeader, SeqNumber, ARUUID, API, SlotNumber, SubslotNumber, Padding* a, Index,
    # RecordDataLength, TargetARUUID b ^ RWPadding* c, RWPadding* d

    # BlockHeader: Type=IODReadReqHeader
    # BlockType: IODReadReqHeader (0x0009)
    profinet_data.extend(['0x00', '0x09'])
    # BlockLength: 60 (0x003c)
    profinet_data.extend(['0x00', '0x00'])

    # IODReadReqHeader BlockLength Index
    ...
    # ARUUID: c4f532e8-9411-4e12-ad47-f2eee393cbbf
    profinet_data.extend(['0xc4', '0xf5', '0x32', '0xe8', '0x94', '0x11', '0x4e', '0x12', '0xad', '0x47', '0xf2', '0xee', '0xe3', '0x93', '0xcb', '0xbf'])
    # API: 0x00000000
    profinet_data.extend(['0x00', '0x00', '0x00', '0x00'])
    # SlotNumber: 0x0000
    profinet_data.extend(['0x00', '0x00'])
    ...
    profinet_data.extend(['0x00', '0x00'])
    # Index: ARData (0xf820)
    profinet_data.extend(['0xf8', '0x20'])
    ...
    # This is fixed at 24 as per the manual
    profinet_data.extend(['0x00', '0x00', '0x00', '0x00', '0x00', '0x00', '0x00', '0x00', '0x00', '0x00','0x00', '0x00', '0x00', '0x00', '0x00','0x00', '0x00', '0x00', '0x00', '0x00', '0x00', '0x00', '0x00', '0x00'])
    ...
    #
    # BlockHeader, InitiatorRPCServerPort
    ...
    profinet_data.extend(['0x01', '0x15'])
    ...
    # InitiatorRPCServerPort
    # Coded as Unsigned16
    # First recommended value from the range is being assigned: 0xC000
    profinet_data.extend(['0xc0', '0x00'])
    # End of block
