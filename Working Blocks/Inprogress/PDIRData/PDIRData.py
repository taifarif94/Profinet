...
def Print_C_String():
    ...
    # PDIRFrameData a b , PDIRBeginEndData
    ...
    # BlockType: 0x0205
    profinet_data.extend(['0x02', '0x05'])
    # BlockLength
    ...
    # Start of Whole block length
    InnerBlockLengthStart = len(profinet_data)
    ...
    # BlockLengthIndex
    InnerBlockLengthIndex = len(profinet_data) - 2
    ...
    profinet_data.extend(
        ['0xe3', '0xf0', '0x22', '0xb4', '0x5a', '0xcc', '0x41', '0xa1', '0xbe', '0x98', '0x40', '0xe3', '0x00', '0xb9',
         '0xc0', '0x71'])
    ...
    # Block Length End
    InnerBlockLengthEnd = len(profinet_data)
